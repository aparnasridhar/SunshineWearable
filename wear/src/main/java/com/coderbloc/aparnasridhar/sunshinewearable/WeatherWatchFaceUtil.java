...
public final class WeatherWatchFaceUtil {
     ...
     */
    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_BACKGROUND = "Teal";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_BACKGROUND = Color.parseColor("#03A9F4");
