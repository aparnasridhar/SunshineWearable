...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener{
    ...
    public SunshineSyncAdapter(Context context, boolean autoInitialize) {
        ...
        Log.v(LOG_TAG, "Trying to connect");
    ...
    public void sendWeatherData(){
        ...
        Log.v(LOG_TAG,"Sending Weather Data");
        ...
        String highText=Utility.formatTemperature(mContext,cursor.getDouble(INDEX_MAX_TEMP));
        String lowText=Utility.formatTemperature(mContext,cursor.getDouble(INDEX_MIN_TEMP));
        int weatherId = cursor.getInt(INDEX_WEATHER_ID);


        PutDataMapRequest mapRequest=PutDataMapRequest.create("/wear-weather");
        DataMap dataMap = mapRequest.getDataMap();
        dataMap.putString(HIGH_KEY, highText);
        dataMap.putString(LOW_KEY, lowText);
        dataMap.putInt(ID_KEY, weatherId);
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "26293ef676f75754da5b3ceffdf9afc6")
                    .build();
